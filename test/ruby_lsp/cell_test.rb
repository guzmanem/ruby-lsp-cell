  ...
  class CellTest < Minitest::Test
    ...
    def test_class
      ...
      with_server(source, uri) do |server, uri|
        ...
        assert_equal 0, response[0].range.end.line
      end
    end
    ...
    def test_functions
      ...
      with_server(source, uri) do |server, uri|
        ...
        assert_equal "/test/show.erb", response[0].command.arguments[0]
        assert_equal 0, response[0].range.start.line
        assert_equal 18, response[0].range.end.line
        ...
        assert_equal 3, response[1].range.end.line
        ...
        assert_equal 5, response[2].range.start.line
        assert_equal 7, response[2].range.end.line
        ...
        assert_equal 9, response[3].range.start.line
        assert_equal 11, response[3].range.end.line
      end
    end
