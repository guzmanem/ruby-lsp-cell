...
class RBS::AST::TypeParam
  ...
  def eql?(other); end
  def hash; end
  def initialize(name:, variance:, upper_bound:, location:, default_type: nil, unchecked: nil); end
  def location; end
  def map_type(&block); end
  def name; end
...
class RBS::EnvironmentLoader::Library < Anonymous_Struct_2
end
...
class RBS::DefinitionBuilder::MethodBuilder::Methods::Definition < Anonymous_Struct_3
  def accessibility; end
  def original; end
...
class RBS::Prototype::RB::Context < Anonymous_Struct_4
...
class RBS::Parser
  ...
  def self.parse_method_type(source, range: nil, variables: nil, require_eof: nil); end
  def self.parse_signature(source); end
  def self.parse_type(source, range: nil, variables: nil, require_eof: nil); end
end
